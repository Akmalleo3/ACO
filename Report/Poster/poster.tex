...
\begin{columns}
    ...
    \block{Problem}{
        ...
        \item This model for synchronization greatly simplifies the shared read 
    ...
    \block{Results}{
        \includegraphics[width=1.0\linewidth,height=13.0cm]{ch130_performance_vs_ants.jpg}
       \includegraphics[width=1.0\linewidth]{ch130_serial_vs_dist.jpg}
       }
    ...
    \block{Methods}{
        ...
        other ants. The goal is for the positive feedback mechanism, encapsulated in the pheremone matrix,
